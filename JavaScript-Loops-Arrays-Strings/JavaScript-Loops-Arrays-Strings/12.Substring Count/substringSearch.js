﻿function countSubstringOccur(arr) {
    ...
    var myRegex = new RegExp(keyWord, 'g'); //create a regex to match
    var count = textToLower.match(myRegex);

    return count.length;
}

console.log(countSubstringOccur(["in", "We are living in a yellow submarine. We don't have anything else. Inside the " +
